...
class PaddockEventFormScreen extends StatefulWidget {
  final int paddockId;
  final PaddockEvent? event;

  const PaddockEventFormScreen({
    super.key,
  ...
  @override
  State<PaddockEventFormScreen> createState() => _PaddockEventFormScreenState();
}

class _PaddockEventFormScreenState extends State<PaddockEventFormScreen> {
  static const _eventTypes = [
    'Abono',
    'Fumigación',
    'Ingreso de terneras a pastoreo',
    'Salida terneras de pastoreo',
    'Días de pastoreo',
    'Riego',
    'Reparación de cerca',
    'Otros',
  ...
  String _defaultAmountType(String eventType) {
    if (eventType == 'Ingreso de terneras a pastoreo' ||
        eventType == 'Salida terneras de pastoreo' ||
        eventType == 'Días de pastoreo' ||
        eventType == 'Otros') {
      return 'neutral';
    }
    return 'expense';
  ...
  Future<void> _save() async {
    ...
    if (widget.event == null) {
      await _database.insertPaddockEvent(event);
    } else {
      await _database.updatePaddockEvent(event);
    }
